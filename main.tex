...
\begin{frame}[plain]{\white{Program Synthesis}}
  % Searching program space exhaustively is impossible, because of the halting problem.
  % Naturally, Alan Turing deserves credit here.
  % (pause)
  % However, the work of Lenat and especially Schmidhuber essentially finds:
...
\begin{frame}{\white{Program Synthesis \& Learning}}
  ...
  % It starts with an engineering problem, for example: Image Classification
...
\begin{frame}{AutoML-Zero: Evolving Machine Learning Algorithms From Scratch \white{\cite{real2020automl}}}
  % With that framework in mind, consider AutoML-Zero, the paper by Esteban Real et al
  % The goal of this paper is to learn how to do machine learning from scratch.
  ...
  %     an evolutionary algorithm. I'll explain how this works in detail later.
    \begin{vfilleditems}
...
\begin{frame}{Pareto Fronts}
  ...
  % This equivalence is defined by an ordering on fitness vectors.
  ...
  % Sets of Pareto-equivalent programs form Pareto-fronts, where each algorithm has trade-offs with one-another. 
...
% Overlay "Methods" on Mandelbrot
% \begin{frame}[plain, noframenumbering]{}
%   \vspace*{-4em}
%   \hspace*{-4em}
%   \begin{overpic}[width=1.2\linewidth,keepaspectratio]{figures/mandelbrot_2.jpg}
%    \put (60,45) {\red{\Huge Methods}}
%   \end{overpic}
% \end{frame}