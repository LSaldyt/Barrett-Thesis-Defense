...
\lstdefinelanguage{Grammar}
    ...
    keywordstyle=\color{c4},
    sensitive=false,
    emph={sin, cos, uniform, gauss, x, y, goal, Add, Sub, Mult, Div, Mod, Pow, UAdd, USub, Not, Invert, And, Or, Eq, NotEq, Lt, LtE, Gt, GtE, Is}, % Custom highlighting
...
\begin{frame}[fragile]\frametitle{Evolvable Python Programs}
  \lstinputlisting[language=Python]{code_examples/rrt_example.py}
\end{frame}
...
\begin{frame}[plain]{}
    ...
    \onslide<2->{\cb{MetaLearning and Specialization}}
\end{frame}
