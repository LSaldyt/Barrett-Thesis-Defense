...
\begin{frame}{Evolutionary/Genetic Algorithms}
  ...
  % 
  % In a nutshell, evolutionary programming keeps a population
  ...
  % Points are selected for based on their x and y components.
...
\begin{frame}{Regularized Evolution}
  % First I'll introduce Regularized evolution, which is the simplest part of AutoML-Zero
  % 
...
\begin{frame}[plain]{Program Learning Template}
\begin{figure}
    \centering
    \includegraphics[width=0.9\linewidth]{figures/meme.jpg}
\end{figure}
\end{frame}
